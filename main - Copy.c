...
void gameOver(GAMESTATE *game_over);
...
void start_screen(GAMESTATE *game_screen)
{
    ...
    SDL_Rect textbox = {130, 70, 420, 70};
    ...
    SDL_Rect textbox2 = {110, 140, 460, 50};
    ...
    SDL_Rect textbox3 = {100, 480, 480, 50};
...
void gameOver(GAMESTATE *game_over)
{
    ...
    text2 = TTF_RenderText_Solid(font, "*To play again restart the program", white);
    SDL_Texture *texture22 = SDL_CreateTextureFromSurface(R3, text2);
    SDL_Rect textbox2 = {170, 150, 360, 50};
